<div class="modal fade" id="pasienForm" tabindex="-1" aria-labelledby="pasienFormLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="pasienFormLabel">Tambah Data</h5>
      ...
      <div class="modal-body">
        <form id="formPasien" action="{{ route('pasien.store') }}" method="POST">
          ...
          <div id="formPesanan">
            <hr>
            <h5 class="mb-3 modal-title">Pesanan</h5>
